...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        buyers = new Buyer[] {
                new Buyer("Vlad", "Ivanov", (short) 21, "+79096134495", Gender.male),
                new Buyer("Irina", "Sidorova", (short) 32, "+79334534455", Gender.female)
        };
     ...
     */
    public static Order makeAPurchase(String buyersPhoneNumber, String productName, short quantityOfGoodsPurchased)
        ...
        if (buyer == null) {
            throw new CustomerException(
                    String.format("Покупатель с номером %s не найден. Заказ отменен.\n", buyersPhoneNumber));
        }
